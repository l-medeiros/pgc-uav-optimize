...
def build_visit_order(
    ...
    while unvisited:
        ...
        for j in unvisited:
            ...
            key = (-aoi_before[j], nodes_map.distances[(current, j)], j)
...
def main():
    ...
    parser.add_argument("--aoi-state",     default="setup/aoi_state_aoi_greedy.csv")
    parser.add_argument("--aoi-history",   default="setup/aoi_history_aoi_greedy.csv")
    parser.add_argument("--round-summary", default="setup/round_summary_aoi_greedy.csv")
