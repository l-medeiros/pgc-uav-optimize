...
\begin{frame}{Motivação: aplicações no mundo real}
  \begin{columns}[c]
    \begin{column}{0.64\textwidth}
      ...
      \begin{itemize}
        \item \textbf{Agricultura de precisão:} dados de sensores de solo e monitoramento de lavouras (DJI Agras).
        \item \textbf{Monitoramento ambiental remoto:} sensores e boias em áreas sem cobertura de rede.
        \item \textbf{Resposta a desastres:} coleta contornando a infraestrutura danificada (ex.: CLARKE, Texas A\&M).
        \item \textbf{Redes IoT/LoRaWAN:} o drone atua como \emph{data mule}.
      \end{itemize}
    \end{column}
  ...
  \end{columns}
  \vspace{0.3em}
  {\small A seguir, dois casos em destaque.}
\end{frame}
