...
\begin{frame}{Escala espacial e o papel das heurísticas}
  \begin{itemize}
    \item Cenários até $1000\times1000$\,m: a discretização (1 transição por \emph{slot} a $\Delta t = 10$\,s) torna áreas maiores inviáveis.
    \item Aumentar $\Delta t$ viabilizaria áreas maiores, mas quebra a comparação com os cenários menores.
    \item O modelo exato também é custoso em tempo e memória em instâncias grandes.
    \item Heurísticas: alternativa rápida, leve e com qualidade próxima ao ótimo.
  \end{itemize}
\end{frame}
