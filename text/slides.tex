...
\begin{frame}{Trabalhos relacionados}
  ...
  \end{center}
  \vspace{0.5em}
  Lacuna: nenhum trabalho anterior \textbf{otimiza AoI e energia conjuntamente}. Este é o único, via formulação exata (MILP) com parâmetros físicos reais de VANTs.
\end{frame}
