...
\begin{document}
    ...
    é planejar a trajetória de um ou mais UAVs para coleta eficiente de dados em sensores IoT, respeitando restrições de mobilidade, energia, e requisitos de comunicação. O problema pode ser formulado pelas seguintes equações:
    ...
    Diferentemente de modelos que usam grafos esparsos, aqui adotamos:
    
    \[
    A = N \times N,
    \]
    
    um grafo dirigido completo com \emph{self-loops}.  
    Isso significa que:
    
    \begin{itemize}
        \item o UAV pode transitar de qualquer nó para qualquer outro em um único slot;
    ...
    Também impomos que cada sensor seja visitado no máximo uma vez:
    ...
    O modelo de consumo energético utilizado é baseado no modelo de potência para VANTs de asa rotativa descrito por Zeng \& Mu (2017), que considera três componentes:
