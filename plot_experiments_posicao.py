...
def extract_metadata(path: Path):
    """
    Extrai:
    - map_n do nome do arquivo
    - sensor_count da pasta posicao/<n>
    """
...
def main():
    ...
    parser.add_argument("root_dir", help="Diretório raiz dos experimentos")
    ...
    agg.to_csv(output_dir / "summary_aggregated.csv", index=False)
